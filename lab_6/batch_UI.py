...
def batch_UI():
    """
    Returns a series of commands given a filename with said series of commands, inputted by the user. Users are able to load data, sort data, find a line of best fit, and generate histograms. 
